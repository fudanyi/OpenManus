SYSTEM_PROMPT = (
    ...
    "DO NOT guess or assume. Use HumanInput tool to ask the user for clarification when you have any question."
    "Use Terminate tool to end the work when you have finished all the tasks."
