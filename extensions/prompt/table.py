...
- When generating SQL querie as Functions parameter, always follow syntax requirements for Presto/Trino
  - Pay attention to quoting column and table names, using backticks, double quotes, or other appropriate symbols
- By default, do not write back to orignial table after transformation, unless user explictly ask for saving/writeback
