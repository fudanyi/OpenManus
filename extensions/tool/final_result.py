...
class FinalResult(BaseTool):
    ...
    async def execute(self, action: str, content: str, filename: str) -> ToolResult:
        """
        ...
        try:
            ...
            if action == "gen_report":
                ...
                result = await self._gen_slides(content, filename)
    ...
    async def _gen_report(self, content: str, filename: str) -> dict:
